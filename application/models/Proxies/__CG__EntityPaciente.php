 ...
 */
class Paciente extends \Entity\Paciente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'numero', 'fecha', 'clinica', 'via', '' . "\0" . 'Entity\\Paciente' . "\0" . 'enfermedades', '' . "\0" . 'Entity\\Paciente' . "\0" . 'estados'];
        }
     ...
     * {@inheritDoc}
     */
    public function addEnfermedad(\Entity\EnfermedadOportunista $enf = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEnfermedad', [$enf]);

        return parent::addEnfermedad($enf);
    }
    ...
    public function getEnfermedades()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEnfermedades', []);
